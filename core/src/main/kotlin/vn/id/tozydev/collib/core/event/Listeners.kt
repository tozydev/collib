package vn.id.tozydev.collib.core.event
...
import vn.id.tozydev.collib.core.server.Server
...
infix fun <T : Event> KClass<T>.to(dispatcher: (T) -> CoroutineContext) = Pair(this, dispatcher)
