package vn.id.tozydev.collib.database.core
...
internal val DatabaseConfig.driverClassName: String
    get() =
        when {
...
private fun DatabaseConfig.jdbcUrl(parent: Path) =
 ...
 *
 * @param config The [DatabaseConfig] containing the database connection details.
